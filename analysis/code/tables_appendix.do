...
file open file16 using "$repository/analysis/tables/table19_OLS.tex", replace write
...
file open file17 using "$repository/analysis/tables/table20_FE.tex", replace write
...
foreach d of local distance  {	
	...
	if "`assess'" == "same" {
		***FIXED EFFECTS
	quietly xtreg std_`assess' percent_treated_`d' std_cog_pre std_ncog_pre distto1 distto2 i.gender_num i.race_num i.year i.blockgroup_num i.test_num age_pre if (has_`assess' == 1 | has_`assess' == 2) & (year == 2012 | year == 2013) & (test_num == 1 |test_num == 2| test_num == 3) , fe cluster(child)
	...
	*adding stars
		...
		***FIXED EFFECTS
	quietly xtreg std_`assess' percent_treated_`d' std_cog_pre std_ncog_pre distto1 distto2 i.gender_num i.race_num i.year i.blockgroup_num i.test_num age_pre if (has_`assess' == 1 | has_`assess' == 2) & (test_num == 4 |test_num == 5| test_num == 6 | test_num == 7) , fe cluster(child)
	...
	***FIXED EFFECTS
	quietly xtreg std_`assess' percent_treated_`d' std_cog_pre std_ncog_pre distto1 distto2 i.gender_num i.race_num i.year i.blockgroup_num i.test_num age_pre if (has_`assess' == 1 | has_`assess' == 2) , fe cluster(child)
...
file open file18 using "$repository/analysis/tables/table21_RE.tex", replace write
