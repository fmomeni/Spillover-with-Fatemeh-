...
file open file11 using "$repository/analysis/tables/table14_summary_rings.tex", replace write
...
file open file12 using "$repository/analysis/tables/table15_fadeout.tex", replace write
